const slides = [
    ...
    {   //Slide 3
        ...
        text: `A <strong>PIR sensor</strong> detects movement by measuring <strong>infrared radiation</strong> from objects.`,
    ...
    {   //Slide 6
        ...
        text: `Now, attach the door with the servo motor to the frame.`,
        className: ""
    },
    {   //Slide 7
        image: "srcs/cyberpi/img8/img8_7.png",
        text: `Put the <strong>PIR sensor</strong> on top of the frame and the <strong>Servo driver</strong> on the side.`,
        className: ""
    },
    {   //Slide 8
    ...
    {   //Slide 9
        ...
        text: `Finally, connect all the components.`,
        className: ""
    },
    {   //Slide 10
        image: "srcs/cyberpi/img8/img8_10.png",
        text: `Your automatic door system should look like this.`,
        className: ""
    },
    {   //Slide 11
    ...
    {   //Slide 12
        image: "srcs/cyberpi/img8/img8_12.png",
        text: `Then, add the <strong>Servo Driver</strong> extension as well.`,
        className: ""
    },
    {   //Slide 13
        video: "srcs/cyberpi/img8/img8_13.mp4",
    ...
    {   //Slide 15
        ...
        What happens when you change it to 100?`,
        className: ""
    },
    {   //Slide 16
    ...
    {   //Slide 18
        ...
        text: `Depending on the result of the <strong>PIR sensor block</strong>, the if-else block decides what action to take.`,
        className: ""
    },
    {   //Slide 19
        image: "srcs/cyberpi/img8/img8_19.png",
        text: `Analyze this <strong>flowchart</strong>, there is a <strong>conditional</strong> structure and a <strong>loop</strong>.`,
        className: ""
    },
    {   //Slide 20
        image: "srcs/cyberpi/img8/img8_20.png",
        text: `Drag the following blocks and test this script!`,
        className: ""
    },
    {   //Slide 21
